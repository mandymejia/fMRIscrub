...
clevers = list(clever.Dat1.mean.lev, clever.Dat1.kurt.lev, clever.Dat2.mean.lev, clever.Dat2.kurt.lev, clever.Dat1.mean.rds, clever.Dat2.mean.rds, clever.Dat2.kurt.rds, clever.Dat1.mean.rbd, clever.Dat1.kurt.rbd, clever.Dat2.mean.rbd, clever.Dat2.kurt.rbd)
```
...
for(clever in clevers){
  print(clever$params$choosePCs)
  print(clever$params$method)
  vis_clever(clever)
  vis_clever(clever, log_measure = T)
}
```
