...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/fMRIscrub)](https://cran.r-project.org/package=fMRIscrub)
...
This package builds off of [`fMRItools`](https://github.com/mandymejia/fMRItools), which collects common functions for handling fMRI data, and [`ciftiTools`](https://github.com/mandymejia/ciftiTools) to support working with the CIFTI format. Also check out our new package, [`rrobot`](https://github.com/mandymejia/rrobot), for methods made for robust outlier detection. 
