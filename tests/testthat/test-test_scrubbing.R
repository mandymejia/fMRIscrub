test_that("pscrub works", {
  ...
  fMRIscrub:::plot.IDvols_projection_multi(psx) # expect_warning w/ fusedPCA?
  ...
  fMRIscrub:::plot.IDvols_projection_multi(psx, title = "My Plot")

  psx <- testthat::expect_warning(IDvols(Dat1, ICA_method="R"))
  print(psx)
